...
def correggi_anomalie(df): #rimuove righe con età o tariffe negative
...
def normalizzazione(df):
    colonne_numeriche = ['Età', 'Durata_Abbonamento', 'Tariffa_Mensile', 'Dati_Consumati', 'Servizio_Clienti_Contatti', 'Costo_per_GB']
